    ...
    <div className="container">
      ...
      {play && (
        <>
          ...
          <button className="reset" style={{fontSize:'2rem', padding:'10px 20px'}} onClick={() => setPlay(false)}>
            <IoMdArrowBack />
          </button>
        </>
      )}
      ...
      {winner && (
        <div className="winner">
          ...
          <p style={{ fontSize: "20px", marginTop: "10px" }}>
            click <b onClick={resetGame} style={{ color: "rgb(90, 70, 219)", cursor:'pointer' }}>RESET</b> to play
            again
          </p>
        </div>
      )}
